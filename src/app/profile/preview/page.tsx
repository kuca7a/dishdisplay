...
export default function PreviewPage() {
  ...
  const [status, setStatus] = useState<'loading' | 'opening' | 'no-restaurant' | 'error'>('loading');
  ...
  if (isLoading) {
    return (
      <div className={`${fjallaOne.className} min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-50`}>
      ...
      <div className={`${fjallaOne.className} min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-50`}>
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-600 mb-6">
            Please create a restaurant first before previewing the customer menu.
          </p>
  ...
  return (
    <div className={`${fjallaOne.className} min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-50`}>
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">Opening customer menu preview...</p>
        <p className="text-sm text-gray-500 mt-2">A new window will open shortly</p>
      </div>
    </div>
  );
}
