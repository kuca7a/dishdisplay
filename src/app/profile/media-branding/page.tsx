              ...
              <div className="grid gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Upload your logo and images (URLs for now - file upload coming soon)
                    </CardDescription>
                  </CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Select value={formData.font_family} onValueChange={(value) => handleSelectChange('font_family', value)}>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={formData.theme_style} onValueChange={(value) => handleSelectChange('theme_style', value)}>
                          <SelectTrigger>
