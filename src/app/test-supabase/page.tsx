  ...
  const createTable = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        alert('Please create the table manually in Supabase dashboard. See console for SQL.')
        console.log(`
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">
            This will create a simple table called 'test_items' with id, name, description, and created_at columns.
          </p>
        </CardContent>
      </Card>
