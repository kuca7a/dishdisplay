      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="flex items-center gap-2">
            <MessageCircleQuestion className="h-8 w-8 text-[#5F7161]" />
            ...
            <Card className="max-w-md text-center">
              <CardContent className="p-8">
                <div className="w-20 h-20 bg-[#5F7161]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <MessageCircleQuestion className="h-10 w-10 text-[#5F7161]" />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <Mail className="h-5 w-5 text-[#5F7161]" />
                    <div className="text-left">
                      <p className="font-medium text-sm">Email Support</p>
                      <p className="text-xs text-gray-600">
                        support@dishdisplay.com
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <Phone className="h-5 w-5 text-[#5F7161]" />
                    <div className="text-left">
