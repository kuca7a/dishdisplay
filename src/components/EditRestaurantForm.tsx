...
export function EditRestaurantForm({ restaurant, onSuccess, trigger }: EditRestaurantFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedRestaurant = await restaurantService.update(restaurant.id, updateData);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Update your restaurant information. This will be displayed to your customers.
          </DialogDescription>
        </DialogHeader>
