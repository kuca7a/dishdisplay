...
export default function DinerMenuInteractions({
  ...
  useEffect(() => {
    console.log("uploadingPhotos state changed:", uploadingPhotos);
  }, [uploadingPhotos]);
  ...
  const handlePhotoUpload = async (file: File) => {
    ...
    try {
      ...
      console.log("Uploading to /api/upload-image with type: review");
      ...
      if (response.ok) {
        ...
        console.log("Adding photo to state:", newPhoto);
        setReviewPhotos((prev) => {
          const updated = [...prev, newPhoto];
          console.log("Updated photo array:", updated);
          return updated;
        });
      ...
      console.log("Setting uploadingPhotos to false");
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        console.log(
                          "Current state - uploadingPhotos:",
                          uploadingPhotos,
                          "reviewPhotos.length:",
                          reviewPhotos.length
                        );
                        console.log("reviewPhotos array:", reviewPhotos);
                        console.log(
                          "Button disabled?",
                          uploadingPhotos || reviewPhotos.length >= 5
                        );
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={() => {
                  ...
                  console.log("- reviewPhotos.length:", reviewPhotos.length);
                  console.log("- reviewText.length:", reviewText.length);
                  console.log("- reviewText:", reviewText);

                  const isPhotoReview = selectedAction === "photo-review";
                  const photoReviewDisabled =
                    isPhotoReview &&
                    (reviewPhotos.length === 0 || reviewText.length < 10);
                  console.log("- photoReviewDisabled:", photoReviewDisabled);
                  console.log(
