...
export default function VisitsHistory({ visits, onWriteReview }: VisitsHistoryProps) {
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8 text-gray-500">
            ...
            <p>Scan a QR code at a restaurant to start tracking your dining journey!</p>
          </div>
        </CardContent>
      </Card>
    );
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="font-medium text-lg">{visit.restaurants?.name || "Restaurant"}</h4>
                    ...
                    {visit.restaurants?.address && (
                      <div className="flex items-center gap-1 text-sm text-gray-500 mb-2">
                        ...
                        {visit.restaurants.address}
                        {visit.restaurants.city && `, ${visit.restaurants.city}`}
                      </div>
                    )}

                    {visit.dishes_viewed && visit.dishes_viewed.length > 0 && (
                      <div className="text-sm text-gray-600">
                        <span className="font-medium">Menu items viewed:</span> {visit.dishes_viewed.length}
                      </div>
                    )}
                  </div>
                </div>
