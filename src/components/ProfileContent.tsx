...
export default function ProfileContent() {
  ...
  const tasks = useMemo((): TaskStatus[] => {
    ...
    const hasHours = !!(restaurant.monday_hours || restaurant.tuesday_hours || restaurant.wednesday_hours);
    ...
    return [
      {
        ...
        description: hasBasicInfo && hasContactInfo ? 'Business profile completed' : 'Add your restaurant details and contact information',
      ...
      },
      {
        ...
        description: hasLocation && hasHours ? 'Location and hours set' : 'Add your address and operating hours',
      ...
      },
      {
        ...
        description: hasMenuItems ? `${menuItems.length} menu items added` : 'Upload your menu items',
      ...
      },
      {
        ...
        description: hasBranding ? 'Branding customized' : 'Add your logo and choose brand colors',
      ...
      },
      {
        ...
        description: hasMenuImages ? 'Menu photos added' : 'Upload photos for your menu items',
  ...
  if (isLoading || loading || !isAuthenticated) {
    return (
      <SidebarProvider>
        <AppSidebar />
        <SidebarInset>
          <div className={`${fjallaOne.className} flex items-center justify-center h-screen`}>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <span className="text-[#5F7161]">{completionPercentage}%</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <CardContent className="space-y-4">
                  {incompleteTasks.map((task) => (
                    <div key={task.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      ...
                      <Link href={task.href}>
                        <Button variant="outline" size="sm" className="border-[#5F7161] text-[#5F7161] hover:bg-[#5F7161] hover:text-white">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {completedTasks.map((task) => (
                    <div key={task.id} className="flex items-center gap-4 p-3 bg-green-50 rounded-lg">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm text-gray-600 mb-4">
                    Great job! Your profile is complete. Here are some things you can do next:
                  </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-[#5F7161]">{menuItems.length}</p>
                      </div>
