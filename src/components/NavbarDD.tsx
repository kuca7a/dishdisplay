      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-black dark:text-white px-4 py-2 rounded-md hover: cursor-pointer"
            ...
            {!isAuthenticated ? (
              ...
              <div className="flex flex-col space-y-2">
                ...
                <button
                  ...
                  className="text-black dark:text-white font-['Fjalla_One'] hover:text-gray-700 dark:hover:text-gray-300 transition-colors text-left hover:cursor-pointer"
                >
                  Log Out
                </button>
              </div>
