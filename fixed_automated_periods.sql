-- Fixed Automated Leaderboard Period Management
...
BEGIN
    ...
    -- 1. Close any expired periods (FIXED: qualify table column)
    UPDATE leaderboard_periods 
    SET leaderboard_periods.status = 'completed', updated_at = NOW()
    ...
    UPDATE leaderboard_periods 
    SET leaderboard_periods.status = 'active', updated_at = NOW()
