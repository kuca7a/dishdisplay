-- Fixed Automated Leaderboard Period Management (Version 5)
-- This fixes the type mismatch by casting varchar to text
...
BEGIN
    ...
    -- Return current active period info (FIXED: cast status to TEXT)
    RETURN QUERY
    SELECT 
        ...
        lp.status::TEXT as period_status
    FROM leaderboard_periods lp
